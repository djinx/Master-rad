...
\thesistitle{Predviđanje funkcije proteina} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\include{Chapters/BioloskeOsnove}
\include{Chapters/PredikcijaNeuredjenostiProteina}
\include{Chapters/Aplikacija}
